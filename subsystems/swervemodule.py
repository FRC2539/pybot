...
FeedbackDevice, AbsoluteSensorRange, RemoteSensorSource, SensorTerm, SensorInitializationStrategy
...
class SwerveModule:
    ...
    def getWheelAngle(self):
        ...
        return (self.turnMotor.getSensorCollection().getIntegratedSensorAbsolutePosition()/constants.drivetrain.driveMotorGearRatio)
